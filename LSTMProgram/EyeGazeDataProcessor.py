...
class GestureDataProcessor:
    ...
    def cross_validation(self):
        ...
        self.trainFile = list(itertools.combinations(numbers, 8))

        for sublist in self.trainFile:
            remaining_numbers = [num for num in numbers if num not in sublist]
            self.testFile.append(remaining_numbers)

            #print(sublist, remaining_numbers)
